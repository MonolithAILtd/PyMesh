...
class MergeMeshesTest(TestCase):
    def test_2_meshes(self):
        ...
        self.assertEqual(
            mesh_1.num_vertices + mesh_2.num_vertices, out_mesh.num_vertices
        )
        self.assertEqual(mesh_1.num_faces + mesh_2.num_faces, out_mesh.num_faces)
        self.assertEqual(mesh_1.num_voxels + mesh_2.num_voxels, out_mesh.num_voxels)
    ...
    def test_3_meshes(self):
        ...
        self.assertEqual(
            mesh_1.num_faces + mesh_2.num_faces + mesh_3.num_faces, out_mesh.num_faces
        )
        self.assertEqual(
