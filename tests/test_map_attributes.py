from pymesh.meshutils import generate_icosphere, generate_box_mesh
from pymesh.map_attributes import (
...
class MapAttributesTest(TestCase):
    def test_map_vertex_attributes_sphere(self):
        ...
        mesh1 = generate_icosphere(2.0, [0.0, 0.0, 0.0], 2)
        mesh2 = generate_icosphere(2.0, [0.0, 0.0, 0.0], 3)

        mesh1.add_attribute("x")
        mesh1.set_attribute("x", mesh1.vertices[:, 0])
        map_vertex_attribute(mesh1, mesh2, "x")
    ...
    def test_map_vertex_attributes_sphere_box(self):
        ...
        mesh1 = generate_icosphere(2.0, [0.0, 0.0, 0.0], 2)
        mesh2 = generate_box_mesh(np.ones(3) - 2, np.ones(3), 10)
        ...
        map_vertex_attribute(mesh1, mesh2, "theta")
    ...
    def test_map_face_attribute_sphere(self):
        mesh1 = generate_icosphere(2.0, [0.0, 0.0, 0.0], 2)
        mesh2 = generate_icosphere(2.1, [0.0, 0.0, 0.0], 2)
        ...
        map_face_attribute(mesh1, mesh2, "value")
    ...
    def test_map_corner_attribute_sphere(self):
        ...
        map_corner_attribute(mesh1, mesh2, "test")
