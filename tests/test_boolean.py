...
class BooleanTest(TestCase):
    ...
    def test_edge_edge_touch(self):
        mesh_1 = generate_box_mesh(np.array([0, 0, 0]), np.array([1, 1, 1]))
        mesh_2 = generate_box_mesh(np.array([0, 1, 1]), np.array([1, 2, 2]))
    ...
    def test_eps_corner_intersection(self):
        ...
        mesh_1 = generate_box_mesh(np.array([0, 0, 0]), np.array([1, 1, 1]))
        mesh_2 = generate_box_mesh(np.array([1, 1, 1]) - eps, np.array([3, 3, 3]))
    ...
    def test_eps_edge_intersection(self):
        eps = np.finfo(np.float64).eps
        mesh_1 = generate_box_mesh(np.array([0, 0, 0]), np.array([1, 1, 1]))
        mesh_2 = generate_box_mesh(np.array([0, 1 - eps, 1 - eps]), np.array([1, 2, 2]))
    ...
    def test_eps_face_intersection(self):
        eps = np.finfo(np.float64).eps
        mesh_1 = generate_box_mesh(np.array([0, 0, 0]), np.array([1, 1, 1]))
        mesh_2 = generate_box_mesh(np.array([0, 0, 1 - eps]), np.array([1, 1, 2]))
    ...
    def test_face_corner_touch(self):
        ...
        rot = Quaternion.fromData(
            np.array([1, 1, 1], dtype=float), np.array([0, 0, 1], dtype=float)
        )
        mesh_2 = form_mesh(
            np.dot(rot.to_matrix(), mesh_1.vertices.T).T + np.array([0.5, 0.5, 1.0]),
            mesh_1.faces,
        )
    ...
    def test_face_corner_touch_off_center(self):
        ...
        mesh_2 = form_mesh(
            np.dot(rot.to_matrix(), mesh_1.vertices.T).T + np.array([0.6, 0.6, 1.0]),
            mesh_1.faces,
        )
    ...
    def test_face_edge_touch(self):
        ...
        rot = Quaternion.fromData(
            np.array([1, 0, 1], dtype=float), np.array([0, 0, 1], dtype=float)
        )
        mesh_2 = form_mesh(
            np.dot(rot.to_matrix(), mesh_1.vertices.T).T + np.array([0.5, 0.5, 1.0]),
            mesh_1.faces,
    ...
    def test_union_with_rotated_self(self):
        ...
        rot = Quaternion.fromAxisAngle(np.array([1, 1, 0], dtype=float), math.pi * 0.5)
        mesh_2 = form_mesh(
            np.dot(rot.to_matrix(), mesh_1.vertices.T).T + np.array([0.5, 0.5, 0.5]),
            mesh_1.faces,
        )
    ...
    def test_edge_edge_orthogonal_touch(self):
        ...
        mesh_2 = form_mesh(
            ...
            + np.array(
                [-math.sqrt(2) / 4.0 + eps, math.sqrt(2) / 4.0 + eps, 0.0], dtype=float
            ),
            mesh_1.faces,
        )
    ...
    def test_intersection_with_slighly_rotated_self(self):
        ...
        mesh_2 = form_mesh(np.dot(rot.to_matrix(), mesh_1.vertices.T).T, mesh_1.faces)
    ...
    def test_rotation_180(self):
        ...
        rot = Quaternion.fromAxisAngle(np.array([1.0, 1.0, 0.0]), math.pi / 2.0)
        mesh_2 = form_mesh(np.dot(rot.to_matrix(), mesh_1.vertices.T).T, mesh_1.faces)
