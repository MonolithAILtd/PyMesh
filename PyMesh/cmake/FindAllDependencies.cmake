...
# TBB
if (NOT TBB_FOUND)
    set(TBB_ROOT ${PROJECT_SOURCE_DIR}/../pymesh/third_party/)
...
if (NOT CGAL_FOUND)
    set(CGAL_DIRS
        "${PROJECT_SOURCE_DIR}/../pymesh/third_party/lib/cmake/CGAL"
        "${PROJECT_SOURCE_DIR}/../pymesh/third_party/lib64/cmake/CGAL"
    )
    set(CGAL_DO_NOT_WARN_ABOUT_CMAKE_BUILD_TYPE TRUE)
    if (NOT Boost_FOUND)
        set(BOOST_ROOT ${PROJECT_SOURCE_DIR}/../pymesh/third_party)
...
if (NOT Mmg_FOUND)
    ...
    ELSE (DEFINED ENV{MMG_PATH})
        set(MMG_BUILD_DIR ${PROJECT_SOURCE_DIR}/../pymesh/third_party/)
...
if (NOT GEOGRAM_FOUND)
    set(GEOGRAM_INSTALL_PREFIX ${PROJECT_SOURCE_DIR}/../pymesh/third_party)
...
if (NOT TARGET nlohmann_json::nlohmann_json)
    ...
    message(${PROJECT_SOURCE_DIR}/../pymesh/third_party/${CMAKE_INSTALL_DATADIR}/cmake/nlohmann_json)
    find_package(nlohmann_json QUIET REQUIRED
      HINTS ${PROJECT_SOURCE_DIR}/../pymesh/third_party/${CMAKE_INSTALL_DATADIR}/cmake/nlohmann_json)
endif()
