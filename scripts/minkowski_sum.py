...
from pymesh.minkowski_sum import minkowski_sum
...
def main():
    ...
    wires_ = wires.WireNetwork.create_from_file(args.path)
    path = chain_wires(wires_)

    result = minkowski_sum(mesh, path)
