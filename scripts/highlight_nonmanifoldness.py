...
def main():
    ...
    mu.is_vertex_manifold(mesh)
    mu.is_edge_manifold(mesh)
    ...
    matrixio.save_matrix("nonmanifold_edges.dmat", involved_faces)
    ...
    print(involved_faces)
    matrixio.save_matrix("nonmanifold_vertices.dmat", involved_faces)
    ...
    if args.debug_output is not None:
        ...
        debug_mesh = mio.form_mesh(mesh.vertices, debug_faces)
        mio.save_mesh(args.debug_output, debug_mesh)
