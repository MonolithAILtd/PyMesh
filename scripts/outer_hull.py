...
def main():
    ...
    result = pymesh.compute_outer_hull(
        mesh, engine=args.engine, all_layers=args.recursive
    )
    ...
    if args.recursive:
        ...
        for i, outer_hull in enumerate(result):
            ...
            pymesh.save_mesh(out_name, outer_hull, *outer_hull.get_attribute_names())
    else:
        pymesh.save_mesh(args.output_mesh, result, *result.get_attribute_names())
