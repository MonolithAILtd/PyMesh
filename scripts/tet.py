...
def parse_args():
    ...
    parser.add_argument(
        "--radius-edge-ratio", help="Max radius to edge ratio", type=float, default=2.0
    )
    parser.add_argument(
        "--cell-size", help="Max circumradius of tets", type=float, default=-1.0
    )
    parser.add_argument(
        "--facet-distance",
...
def main():
    ...
    mio.save_mesh(args.out_mesh, tet_mesh)
