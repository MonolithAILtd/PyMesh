...
def main():
    ...
    if not args.save_uv:
        ...
        mio.save_mesh(args.output_mesh, cutted_mesh, "u", "v")
    else:
        uv_mesh = mio.form_mesh(per_vertex_uv, faces)
        mio.save_mesh(args.output_mesh, uv_mesh)
