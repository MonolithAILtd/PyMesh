...
from pymesh.meshutils import separate_mesh
import os.path
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="the meaning of connected",
        default="auto",
    )
    parser.add_argument(
        "--highlight", action="store_true", help="Highlight disconnected components"
    )
...
def main():
    ...
    if args.highlight:
        ...
        for i in range(len(comps)):
            elem_sources = comps[i].get_attribute("ori_elem_index").ravel().astype(int)
