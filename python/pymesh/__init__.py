...
from .manifold_plus import compute_manifold_mesh_plus
...
try:
    ...
    logging.getLogger(__name__).warning("Arrangement computation is unavailable")
...
try:
    ...
    logging.getLogger(__name__).warning("TetGen is unavailable")
