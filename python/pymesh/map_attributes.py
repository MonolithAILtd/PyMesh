...
def map_corner_attribute(mesh1, mesh2, attr_name, bvh=None):
    ...
    val_p0 = (
        values[f_closest_faces, 0, :] * p0_a12
        + values[f_closest_faces, 1, :] * p0_a20
        + values[f_closest_faces, 2, :] * p0_a01
    ) / a
    val_p1 = (
        values[f_closest_faces, 0, :] * p1_a12
        + values[f_closest_faces, 1, :] * p1_a20
        + values[f_closest_faces, 2, :] * p1_a01
    ) / a
    val_p2 = (
        values[f_closest_faces, 0, :] * p2_a12
        + values[f_closest_faces, 1, :] * p2_a20
        + values[f_closest_faces, 2, :] * p2_a01
    ) / a
